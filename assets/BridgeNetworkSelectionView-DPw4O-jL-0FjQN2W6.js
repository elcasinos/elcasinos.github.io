import{V as N,a0 as P,a1 as w,i as t}from"./privyHost-xyLifhRG.js";import{n as I}from"./getErc20Balance-DHgWH7_1-DfZy6sc-.js";import{r as R,j as e,q as U,s as q,y as E,v as z,w as D,x as O}from"./vendor-react-Dw-pcWBf.js";import{u as Q,h as V}from"./ModalFooter-DKyozrEX-Bp-d8DBB.js";import{c as W,s as Y}from"./Layouts-BMRfo5hw-C5ozzrT8.js";import{t as G}from"./FundWalletMethodHeader-CkyJhN9p-DcGuKBGo.js";import{s as $,e as g,n as H}from"./Value-DTgR824E-1vh5YH35.js";import{e as J}from"./ErrorMessage-D8VaAP5m-CrX49xjE.js";import{r as K}from"./Subtitle-CV-2yKE4-EKL8SH3F.js";import{e as L}from"./Title-BnzYV3Is-Cjqfrcue.js";import{e as F}from"./getChainName-DjpPdUSc-c2urPd0g.js";import{n as M}from"./Chip-CZKIKt9K-BdyAEHne.js";import{w as X}from"./TransferOrBridgeLoadingScreen-DUbPtRQe-JLEIhOy-.js";import{d as Z,e as _}from"./shared-FM0rljBt-0XfNqj02.js";import{t as C}from"./formatErc20TokenAmount-BuPk9xcy-CkAr4Oc0.js";import{c as k}from"./ethers-DKNnmkib-CU0xloV9.js";import{a as ee,p as re,s as ae,c as ne,l as ie}from"./styles-C9oLwuTf-Clo3AMcm.js";import{q as se,r as te}from"./vendor-wagmi-B1Ud2aV8.js";const Re=({chains:i,appId:r,address:a,rpcConfig:c})=>Promise.all(i.map(async n=>{let l=se({chain:n,transport:te(N(n,c,r))}),m=await l.getBalance({address:a}).catch(()=>0n),h=null,s=P[n.id];if(s){let{balance:p}=await I({address:a,chain:n,rpcConfig:c,appId:r,erc20Address:s});h=p}return{balance:m,erc20Balance:h,erc20Address:s,chain:n}})),oe=({balance:i,className:r,chain:a})=>e.jsx(Z,{className:r,$state:void 0,children:e.jsx(x,{balance:i,chain:a})}),x=({balance:i,chain:r})=>e.jsxs(e.Fragment,{children:[e.jsxs(ce,{children:[e.jsx(de,{chainId:typeof r=="object"?r.id:"solana"}),e.jsx(H,{children:typeof r=="object"?r.name:F(r)})]}),e.jsxs(M,{isLoading:!1,isPulsing:!1,color:"gray",children:[e.jsx(le,{children:e.jsx(D,{})}),i]})]});let ce=t.div`
  display: flex;
  align-items: center;
`,le=t.div`
  height: 0.75rem;
