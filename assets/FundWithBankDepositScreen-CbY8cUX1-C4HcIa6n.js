import{r as f,j as t}from"./vendor-react-Dw-pcWBf.js";import{p as P,b as z,bt as D,bu as E,c9 as V,A as R,i as v}from"./privyHost-Cz-MbqeF.js";import{h as Y}from"./CopyableText-CQapvaMr-D_8uiwda.js";import{n as C}from"./ScreenLayout-DTsWfKKs-C-HsaiV5.js";import{t as M}from"./InfoBanner-Cb3p1z12-B0qOHC_i.js";import{w as K,c as O,p as q}from"./SelectSourceAsset-CXcAyH34-DAPr5pk4.js";import"./vendor-wagmi-B1Ud2aV8.js";import{bu as H,bf as N,a$ as X,b5 as U}from"./vendor-icons-CaM6nBRi.js";import"./index-BgB3H9hs.js";import"./vendor-query-CymX7U7d.js";import"./vendor-ethers-Bhe0LPGS.js";import"./ModalFooter-DKyozrEX-cOVsDVvg.js";import"./Screen-DMmH56yL-DgsMGBRe.js";import"./index-CWARkn2w-B0MCq68L.js";const G=e=>{try{return e.location.origin}catch{return}},J=({data:e,onClose:a})=>t.jsx(C,{showClose:!0,onClose:a,title:"Initiate bank transfer",subtitle:"Use the details below to complete a bank transfer from your bank.",primaryCta:{label:"Done",onClick:a},watermark:!1,footerText:"Exchange rates and fees are set when you authorize and determine the amount you receive. You'll see the applicable rates and fees for your transaction separately",children:t.jsx(Q,{children:(V[e.deposit_instructions.asset]||[]).map(([u,y],g)=>{let d=e.deposit_instructions[u];if(!d||Array.isArray(d))return null;let o=u==="asset"?d.toUpperCase():d,h=o.length>100?`${o.slice(0,9)}...${o.slice(-9)}`:o;return t.jsxs(Z,{children:[t.jsx(ee,{children:y}),t.jsx(Y,{value:o,includeChildren:R,children:t.jsx(te,{children:h})})]},g)})})});let Q=v.ol`
