import{r as m,j as e}from"./vendor-react-Dw-pcWBf.js";import{i as n,p as A,ad as I,e as L,b as N,t as b,v as g,j as P,f as S}from"./privyHost-B7YXtMqn.js";import{a as $,c as v}from"./TodoList-DnyULl18-DyUhS2rY.js";import{n as j}from"./ScreenLayout-DTsWfKKs-D4n_BFp2.js";import{aZ as z,a_ as C,a$ as B}from"./vendor-icons-C_pdg3T2.js";import"./index-UsSeARm5.js";import"./vendor-wagmi-B1Ud2aV8.js";import"./vendor-query-CymX7U7d.js";import"./vendor-ethers-CKvxFtAV.js";import"./ModalFooter-DKyozrEX-DFiaIlCI.js";import"./Screen-DMmH56yL-DarVlEcL.js";import"./index-CWARkn2w-B-Z8Wl_H.js";const U=({passkeys:i,name:c,isLoading:u,errorReason:f,success:o,expanded:a,onLinkPasskey:y,onUnlinkPasskey:t,onExpand:r,onBack:s,onClose:l})=>o?e.jsx(j,{title:"Passkeys updated",icon:z,iconVariant:"success",primaryCta:{label:"Done",onClick:l},onClose:l,watermark:!0}):a?e.jsx(j,{icon:C,title:"Your passkeys",onBack:s,onClose:l,watermark:!0,children:e.jsx(E,{passkeys:i,expanded:a,onUnlink:t,onExpand:r})}):e.jsxs(j,{icon:C,title:"Set up passkey verification",subtitle:"Verify with passkey",primaryCta:{label:"Add new passkey",onClick:y,loading:u},onClose:l,watermark:!0,helpText:f||void 0,children:[i.length===0?e.jsx(M,{}):e.jsx(T,{children:e.jsx(E,{passkeys:i,expanded:a,onUnlink:t,onExpand:r})}),c?e.jsxs(W,{children:[e.jsx(_,{children:"New Passkey Name"}),e.jsx(D,{children:c})]}):null]});let T=n.div`
