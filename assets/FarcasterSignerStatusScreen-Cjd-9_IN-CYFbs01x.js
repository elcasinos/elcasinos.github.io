import{f9 as F,fa as T,fb as I,dk as u,fO as w,dl as a,fQ as y,gw as O,fL as _,ft as n}from"./index-B5z1r2tA.js";import{h as q}from"./CopyToClipboard-i_OQSBJr-BIRDhGv3.js";import{n as B}from"./OpenLink-CUpJ1mOr-CokKaaA9.js";import{x as E}from"./QrCode-CpGkVlXb-SyGAP8DI.js";import{n as A}from"./ScreenLayout-DTsWfKKs-CT-bIfYU.js";import{l as h}from"./farcaster-DPlSjvF5-hXjNpYWs.js";import"./dijkstra-D_NXgYpA.js";import"./ModalFooter-DKyozrEX-BDBBb-3k.js";import"./Screen-DMmH56yL-BG7LE4YA.js";import"./index-CWARkn2w-DUlOYVvD.js";let k="#8a63d2";const L=({appName:d,loading:m,success:i,errorMessage:e,connectUri:r,onBack:s,onClose:c,onOpenFarcaster:o})=>a.jsx(A,y||m?O?{title:e?e.message:"Add a signer to Farcaster",subtitle:e?e.detail:`This will allow ${d} to add casts, likes, follows, and more on your behalf.`,icon:h,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!e},primaryCta:r&&o?{label:"Open Farcaster app",onClick:o}:void 0,onBack:s,onClose:c,watermark:!0}:{title:e?e.message:"Requesting signer from Farcaster",subtitle:e?e.detail:"This should only take a moment",icon:h,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!e},onBack:s,onClose:c,watermark:!0,children:r&&y&&a.jsx(M,{children:a.jsx(B,{text:"Take me to Farcaster",url:r,color:k})})}:{title:"Add a signer to Farcaster",subtitle:`This will allow ${d} to add casts, likes, follows, and more on your behalf.`,onBack:s,onClose:c,watermark:!0,children:a.jsxs(R,{children:[a.jsx(N,{children:r?a.jsx(E,{url:r,size:275,squareLogoElement:h}):a.jsx(z,{children:a.jsx(_,{})})}),a.jsxs(P,{children:[a.jsx(V,{children:"Or copy this link and paste it into a phone browser to open the Farcaster app."}),r&&a.jsx(q,{text:r,itemName:"link",color:k})]})]})});let M=n.div`
  margin-top: 24px;
`,R=n.div`
  display: flex;
