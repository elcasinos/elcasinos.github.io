import{r as f,j as t}from"./vendor-react-DSMResu1.js";import{p as P,b as z,bt as D,bu as E,c9 as V,A as R,i as w}from"./privyHost-DbXBs_AW.js";import{h as Y}from"./CopyableText-CQapvaMr-CoNWyeCq.js";import{n as C}from"./ScreenLayout-DTsWfKKs-DG45OC7J.js";import{t as M}from"./InfoBanner-Cb3p1z12-BXa3h7mf.js";import{w as K,c as O,p as q}from"./SelectSourceAsset-CXcAyH34-rX5d3S1f.js";import"./vendor-wagmi-OILVNHfs.js";import{bv as H,bg as N,b0 as X,b6 as U}from"./vendor-icons-CYq85OGz.js";import"./index-fpyUxtlY.js";import"./vendor-query-DxDSQ3I8.js";import"./vendor-ethers-Cg-evgET.js";import"./vendor-charts-CYZL7y4I.js";import"./ModalFooter-DKyozrEX-BNW-X6Xw.js";import"./Screen-DMmH56yL-B-_-JM8F.js";import"./index-CWARkn2w-DiNfn0vR.js";const G=e=>{try{return e.location.origin}catch{return}},J=({data:e,onClose:a})=>t.jsx(C,{showClose:!0,onClose:a,title:"Initiate bank transfer",subtitle:"Use the details below to complete a bank transfer from your bank.",primaryCta:{label:"Done",onClick:a},watermark:!1,footerText:"Exchange rates and fees are set when you authorize and determine the amount you receive. You'll see the applicable rates and fees for your transaction separately",children:t.jsx(Q,{children:(V[e.deposit_instructions.asset]||[]).map(([u,y],g)=>{let d=e.deposit_instructions[u];if(!d||Array.isArray(d))return null;let o=u==="asset"?d.toUpperCase():d,h=o.length>100?`${o.slice(0,9)}...${o.slice(-9)}`:o;return t.jsxs(Z,{children:[t.jsx(ee,{children:y}),t.jsx(Y,{value:o,includeChildren:R,children:t.jsx(te,{children:h})})]},g)})})});let Q=w.ol`
