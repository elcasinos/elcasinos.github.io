...
`,wn=x.span`
  ...
  font-weight: 400;
  line-height: 1.25rem;
`;const kn=({onClose:e,onBack:t,onContinue:r,onAmountChange:n,onSelectSource:i,onEditSourceAsset:s,onEditPaymentMethod:a,onSelectPaymentMethod:l,onRetry:d,opts:c,state:u,amount:y,error:f,selectedQuote:h,quotesWarning:C,quotesErrors:j,destinationCurrencySymbol:v,quotesCount:w,isLoading:m,isInitialQuoteLoading:L,stripeElement:p})=>u.status==="select-amount"?L?o.jsx(Q,{showClose:!0,onClose:e,iconVariant:"loading"}):o.jsx(cn,{onClose:e,onBack:t,onContinue:r,onAmountChange:n,onEditSourceAsset:s,onEditPaymentMethod:a,opts:c,amount:y,selectedQuote:h,quotesWarning:C,quotesErrors:j,quotesCount:w,destinationCurrencySymbol:v,isLoading:m}):u.status==="select-source-asset"?o.jsx(Xt,{onSelectSource:i,opts:c,isLoading:m}):u.status==="select-payment-method"?o.jsx(fn,{onClose:e,onSelectPaymentMethod:l,quotes:u.quotes,isLoading:m}):u.status==="stripe-flow"?o.jsx(en,{step:u.step,element:p,onClose:e,isLoading:m}):u.status==="provider-confirming"?o.jsx(tn,{onClose:e}):u.status==="provider-error"?o.jsx(on,{onClose:e,onRetry:d,error:f}):u.status==="provider-success"?o.jsx(nn,{onClose:e}):null,Vn={component:()=>{var v;let{onUserCloseViaDialogOrKeybindRef:e}=Mt(),t=T();if(!t)return null;let{opts:r,state:n,error:i,isLoading:s,amount:a,quotesWarning:l,quotesErrors:d,localQuotes:c,localSelectedQuote:u,initialQuotes:y,initialSelectedQuote:f,destinationCurrencySymbol:h,stripeElement:C,onBack:j}=t;return e.current=Ve,o.jsx(kn,{onClose:Ve,onBack:j,opts:r,state:n,error:i,isLoading:s,isInitialQuoteLoading:y==null,amount:a,selectedQuote:Ft({localQuotes:c,localSelectedQuote:u,initialSelectedQuote:f}),quotesWarning:l,quotesErrors:d,quotesCount:((v=c??y)==null?void 0:v.length)??0,destinationCurrencySymbol:h,onAmountChange:hr,onContinue:Ar,onSelectSource:Nr,onEditSourceAsset:Ir,onEditPaymentMethod:Lr,onSelectPaymentMethod:Tr,onRetry:$r,stripeElement:C})}};export{Vn as FiatOnrampScreen,Vn as default};
