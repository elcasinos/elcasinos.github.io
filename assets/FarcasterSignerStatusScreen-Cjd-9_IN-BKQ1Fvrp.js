import{r as u,j as t}from"./vendor-react-Dw-pcWBf.js";import{b as F,a as T,e as I,z as w,A as y,bi as O,o as _,i as n}from"./privyHost-Czbd9vfC.js";import{h as q}from"./CopyToClipboard-i_OQSBJr-BKveXD7z.js";import{n as B}from"./OpenLink-CUpJ1mOr-B24ZPpEG.js";import{x as A}from"./QrCode-CpGkVlXb-Cvrd63Fn.js";import{n as E}from"./ScreenLayout-DTsWfKKs-B47KmGj0.js";import{l as h}from"./farcaster-DPlSjvF5-BvA13vSr.js";import"./index-B1CD0Fgm.js";import"./vendor-wagmi-B1Ud2aV8.js";import"./vendor-query-CymX7U7d.js";import"./vendor-ethers-CKvxFtAV.js";import"./vendor-icons-C_pdg3T2.js";import"./dijkstra-D_NXgYpA.js";import"./ModalFooter-DKyozrEX-CdeTKhc6.js";import"./Screen-DMmH56yL-BAFuBSOJ.js";import"./index-CWARkn2w-9ww4AYQ5.js";let S="#8a63d2";const M=({appName:p,loading:m,success:i,errorMessage:e,connectUri:r,onBack:s,onClose:c,onOpenFarcaster:o})=>t.jsx(E,y||m?O?{title:e?e.message:"Add a signer to Farcaster",subtitle:e?e.detail:`This will allow ${p} to add casts, likes, follows, and more on your behalf.`,icon:h,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!e},primaryCta:r&&o?{label:"Open Farcaster app",onClick:o}:void 0,onBack:s,onClose:c,watermark:!0}:{title:e?e.message:"Requesting signer from Farcaster",subtitle:e?e.detail:"This should only take a moment",icon:h,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!e},onBack:s,onClose:c,watermark:!0,children:r&&y&&t.jsx(R,{children:t.jsx(B,{text:"Take me to Farcaster",url:r,color:S})})}:{title:"Add a signer to Farcaster",subtitle:`This will allow ${p} to add casts, likes, follows, and more on your behalf.`,onBack:s,onClose:c,watermark:!0,children:t.jsxs(z,{children:[t.jsx(L,{children:r?t.jsx(A,{url:r,size:275,squareLogoElement:h}):t.jsx(V,{children:t.jsx(_,{})})}),t.jsxs(N,{children:[t.jsx(P,{children:"Or copy this link and paste it into a phone browser to open the Farcaster app."}),r&&t.jsx(q,{text:r,itemName:"link",color:S})]})]})});let R=n.div`
  margin-top: 24px;
`,z=n.div`
  display: flex;
